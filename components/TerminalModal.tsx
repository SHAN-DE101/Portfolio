...
export default function TerminalModal({
  ...
  const [history, setHistory] = useState<Array<{ command: string; output: string }>>([
    {
      command: "welcome",
      output:
        "Welcome to Shantanu's secure shell (v2.0-edge).\nType 'help' to view available commands, or try 'hack', 'coffee', 'azure', and 'whoami'.",
    },
  ]);
  ...
  const handleCommand = (e: React.FormEvent) => {
    ...
    switch (cmd) {
      ...
      case "azure":
        response =
          "Microsoft Certified: Azure Fundamentals (AZ-900)\nValidated Cloud Computing, Core Azure Services, Security, Privacy, Compliance, and Trust.";
        break;
      case "coffee":
        response =
          "☕ Brewing compilation espresso...\n[████████████████████] 100% — System throughput restored. Ready for high-concurrency sprints.";
        break;
      case "matrix":
        response =
          "01010011 01101000 01100001 01101110 01110100 01100001 01101110 11001010\n[SECURITY AUDIT]: Zero vulnerabilities detected. Firewall active on port 443.";
        break;
      case "clear":
        setHistory([]);
        setInput("");
        ...
        <div className="p-4 h-80 overflow-y-auto space-y-3 selection:bg-emerald-500/30 selection:text-emerald-300">
          ...
          <form onSubmit={handleCommand} className="flex items-center gap-2 text-emerald-400 pt-1">
            ...
            <input
              ...
              autoFocus
              placeholder="type 'help', 'coffee', 'matrix'..."
            />
          </form>
          <div ref={bottomRef} />
        </div>
