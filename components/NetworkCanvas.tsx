...
export default function NetworkCanvas() {
  ...
  useEffect(() => {
    ...
    // Light, performant node particles (distributed network vibe)
      ...
      for (let i = 0; i < particles.length; i++) {
        ...
        for (let j = i + 1; j < particles.length; j++) {
          ...
          if (dist < 130) {
            ...
            ctx.strokeStyle = `rgba(52, 211, 153, ${0.12 * (1 - dist / 130)})`;
            ctx.lineWidth = 0.8;
            ctx.stroke();
          }
        }
        ...
        if (mdist < 150) {
          ...
          ctx.strokeStyle = `rgba(16, 185, 129, ${0.22 * (1 - mdist / 150)})`;
          ctx.lineWidth = 1;
          ctx.stroke();
        }
      }
