...
const GATEWAY_SPECS = {
  ...
  pipeline: [
    ...
    { step: 'Zero-Retention Audit', desc: 'Captures latency, token usage, and status metadata while prompt text is discarded from memory.' },
  ],
  securityHighlights: [
...
const LOGISTICS_SPECS = {
  efuel: {
    ...
    pipeline: [
      { step: 'Client Haversine Resolution', desc: 'Evaluates geodesic distance and Geohash cells on client device to query nearby depots only.' },
